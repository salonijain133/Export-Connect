...
const CreateProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      productFormData.append("pricePerUnit", formData.pricePerUnit)
      productFormData.append("unit", formData.unit)
      productFormData.append("availableQuantity", formData.availableQuantity)
      productFormData.append("originCountry", formData.originCountry)
      productFormData.append("certifications", formData.certifications)
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-none shadow-lg rounded-3xl overflow-hidden">
          <CardHeader className="border-b border-slate-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-2xl font-semibold text-slate-900">Create New Product</CardTitle>
                <p className="text-slate-500 mt-1">Add a new product to your inventory</p>
              </div>
            </div>
          </CardHeader>
